...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post("https://lost-found-backend-kb2t.onrender.com/api/login", form);
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-left h1 span { color: #06b6d4; }
        ...
        .floating-dots {
          ...
          display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; z-index: 1;
        }

        .dot { width: 5px; height: 5px; border-radius: 50%; background: rgba(255,255,255,0.2); }
        ...
        .error-msg {
          ...
          border-radius: 8px; font-size: 0.875rem; margin-bottom: 1.25rem;
        }
        ...
        .auth-footer a { color: #0891b2; font-weight: 500; text-decoration: none; }
